...
gulp.task('move_iconfont' ,function() {
    var imgSrc = './build/**/*.png',
        quoteSrc = './build/**/*.css', // [./output/static/css/**/*.css',./output/static/js/**/*.js']
        imgDst = './build';

    return gulp.src(['./src/common/*.ttf','./src/common/*.woff','./src/common/*.woff2', './src/common/*.ico'])
...
gulp.task("dev",["include",'css','hawksprite','images','move_iconfont'], function () {
...
gulp.task('online', function (cb) {
   ...
   gulpSequence('clean','include1','images','hawksprite','cssmin','jsmin','spritecssmin','cssmd5','jsmd5','imgmd5','copyhtml','cleanhtml','important','publish','msg','move_iconfont',cb);
});

gulp.task('onlinedebug', function (cb) {
   //gulpSequence('clean','cssmin','jsmin','publishinclude','hawksprite','spritecssmin','cssmd5','jsmd5','imgmd5','publish',cb);
   gulpSequence('clean','include1','images','hawksprite','cssmin','jsmin','spritecssmin','cssmd5','jsmd5','imgmd5','move_iconfont',cb);
});
...
gulp.task('qa', function (cb) {
   //gulpSequence('clean','cssmin','jsmin','publishinclude','hawksprite','spritecssmin','cssmd5','jsmd5','imgmd5','publish',cb);
   gulpSequence('clean','qainclude','images','hawksprite','spritecssmin','importantqa','publishqa','msgqa','move_iconfont',cb);
});

gulp.task('qadebug', function (cb) {
   //gulpSequence('clean','cssmin','jsmin','publishinclude','hawksprite','spritecssmin','cssmd5','jsmd5','imgmd5','publish',cb);
   gulpSequence('clean','qainclude','images','hawksprite','spritecssmin','move_iconfont',cb);
});
